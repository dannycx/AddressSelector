...
import com.danny.addressselector.view.adapter.WheelViewAdapter;
...
public class WheelView extends View {
    ...
    private void drawShadows(Canvas canvas) {
        ...
        Log.d("danny.wheel", "getItemHeight(): " + getItemHeight());
        Log.d("danny.wheel", "height: " + height);
        Log.d("danny.wheel", "getWidth: " + getWidth());
        Log.d("danny.wheel", "getHeight():" + getHeight());
        Log.d("danny.wheel", "visibleItems:" + visibleItems);
    }
